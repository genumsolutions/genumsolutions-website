...
const replacements = [
  ...
  { id: "dupont-jst-cable-pack", urls: ["https://cdn-shop.adafruit.com/970x728/1955-00.jpg"] },
  { id: "chassis-fastener-pack", urls: ["https://cdn-shop.adafruit.com/970x728/2881-00.jpg"] },
  { id: "l298p-motor-driver", urls: ["https://cdn-shop.adafruit.com/970x728/808-00.jpg"] },
  { id: "oled-display-09", urls: ["https://cdn-shop.adafruit.com/970x728/326-03.jpg"] },
  { id: "xt60-power-connectors", urls: ["https://cdn-shop.adafruit.com/970x728/2192-00.jpg"] },
];
...
for (const { id, urls } of replacements) {
  ...
  for (const url of urls) {
    try {
      ...
      console.log(`FAIL ${id} ${url}: ${e.message}`);
    }
  }
