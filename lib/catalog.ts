...
const robotCarProducts: Product[] = [
  ...
  { ...standard, id: '4wd4m-basic', name: '4WD4M Basic Robot Car', category: 'Robot Cars', price: 0, priceLabel: 'Request quote', sku: 'GEN-CAR-0004', productType: 'Retail kit', note: 'Four-wheel drive four motor basic build', description: 'Basic 4WD4M robot car with ESP32 control for forward, backward, left, right, and stop operations.', specs: ['ESP32', 'TB6612FNG motor driver', '4 BO motors', 'HC-SR04 ultrasonic sensor'], stock: 0, delivery: 'Kit contents and lead time confirmed with quotation', color: 'from-[#dce8ff] to-[#7e9ff2]', badge: '4wd4m', image: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=600&q=80' },
  { ...standard, id: '2wd1m-basic', name: '2WD1M Basic Robot Car', category: 'Robot Cars', price: 0, priceLabel: 'Request quote', sku: 'GEN-CAR-0005', productType: 'Retail kit', note: 'Two-wheel drive single motor basic build', description: 'Simple 2WD1M robot car with ESP32 Bluetooth control for basic directional operations.', specs: ['ESP32', 'L298N motor driver', '2 BO motors', 'HC-06 Bluetooth module'], stock: 0, delivery: 'Kit contents and lead time confirmed with quotation', color: 'from-[#dff4ec] to-[#79c7a8]', badge: '2wd1m', image: 'https://images.unsplash.com/photo-1553406830-ef2513450d76?auto=format&fit=crop&w=600&q=80' },
  { ...standard, id: 'self-balancing-basic', name: 'Self-Balancing Robot Car', category: 'Robot Cars', price: 0, priceLabel: 'Request quote', sku: 'GEN-CAR-0006', productType: 'Retail kit', note: 'PID-controlled self-balancing build', description: 'Self-balancing car using PID control algorithm with ESP32 and TB6612FNG motor driver.', specs: ['ESP32', 'TB6612FNG motor driver', 'IMU sensor', '2 BO motors'], stock: 0, delivery: 'Kit contents and lead time confirmed with quotation', color: 'from-[#f1e9ff] to-[#c4a8ef]', badge: 'self-balancing', image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=600&q=80' },
  { ...standard, id: 'obstacle-us-basic', name: 'Obstacle-Avoidance (US) Robot Car', category: 'Robot Cars', price: 0, priceLabel: 'Request quote', sku: 'GEN-CAR-0007', productType: 'Retail kit', note: 'Ultrasonic sensor-based obstacle avoidance', description: 'Robot car that autonomously avoids obstacles using HC-SR04 ultrasonic sensor with ESP32.', specs: ['ESP32', 'HC-SR04 ultrasonic sensor', 'L298N motor driver', '2 BO motors'], stock: 0, delivery: 'Kit contents and lead time confirmed with quotation', color: 'from-[#dce8ff] to-[#7e9ff2]', badge: 'obstacle-us', image: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=600&q=80' },
  { ...standard, id: 'obstacle-ir-basic', name: 'Obstacle-Avoidance (IR) Robot Car', category: 'Robot Cars', price: 0, priceLabel: 'Request quote', sku: 'GEN-CAR-0008', productType: 'Retail kit', note: 'IR sensor-based obstacle avoidance', description: 'Robot car that avoids obstacles using IR sensor with ESP32 control.', specs: ['ESP32', 'IR obstacle sensor', 'L298N motor driver', '2 BO motors'], stock: 0, delivery: 'Kit contents and lead time confirmed with quotation', color: 'from-[#dff4ec] to-[#79c7a8]', badge: 'obstacle-ir', image: 'https://images.unsplash.com/photo-1553406830-ef2513450d76?auto=format&fit=crop&w=600&q=80' },
  { ...standard, id: 'website-client-basic', name: 'Website-Client Robot Car', category: 'Robot Cars', price: 0, priceLabel: 'Request quote', sku: 'GEN-CAR-0009', productType: 'Retail kit', note: 'WiFi client control mode', description: 'ESP32 WiFi client car that connects to web dashboard for remote control operations.', specs: ['ESP32', 'WiFi module', 'L298N motor driver', '2 BO motors'], stock: 0, delivery: 'Kit contents and lead time confirmed with quotation', color: 'from-[#f1e9ff] to-[#c4a8ef]', badge: 'website-client', image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=600&q=80' },
  { ...standard, id: 'website-server-basic', name: 'Website-Server Robot Car', category: 'Robot Cars', price: 0, priceLabel: 'Request quote', sku: 'GEN-CAR-0010', productType: 'Retail kit', note: 'WiFi server control mode', description: 'ESP32 WiFi server car that hosts web interface for browser-based control.', specs: ['ESP32', 'WiFi module', 'L298N motor driver', '2 BO motors'], stock: 0, delivery: 'Kit contents and lead time confirmed with quotation', color: 'from-[#dce8ff] to-[#7e9ff2]', badge: 'website-server', image: 'https://images.unsplash.com/photo-1508610048659-a06b669e3321?auto=format&fit=crop&w=600&q=80' },
