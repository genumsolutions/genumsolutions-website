...
const additionalInventoryProducts: Product[] = [
  quoteInventory('arduino-mega', 'Arduino Mega', 'Controllers & Boards', 'GEN-ARD-0002', 'More pins for larger builds', 'A larger Arduino controller for multi-sensor, display, and automation projects.', ['Arduino Mega board', 'Expanded digital and analog I/O', 'USB programming connection'], 'from-[#dce8ff] to-[#7e9ff2]'),
  quoteInventory('arduino-nano', 'Arduino Nano', 'Controllers & Boards', 'GEN-ARD-0003', 'Compact controller for small builds', 'A compact Arduino board for embedded projects and tight robot-car layouts.', ['Arduino Nano board', 'ATmega328-class controller', 'Compact header layout'], 'from-[#dff4ec] to-[#79c7a8]'),
  quoteInventory('esp8266-board', 'ESP8266 Development Board', 'Controllers & Boards', 'GEN-ESP-0002', 'Wi-Fi for compact IoT builds', 'A compact Wi-Fi development board for connected sensors and small automation projects.', ['ESP8266 board', 'Wi-Fi connectivity', 'USB programming connection'], 'from-[#dce8ff] to-[#7e9ff2]'),
  quoteInventory('stm32-board', 'STM32 Development Board', 'Controllers & Boards', 'GEN-STM-0001', 'Advanced embedded control', 'An STM32 board for learners and teams working with higher-performance embedded control.', ['STM32 microcontroller board', 'Digital and analog I/O', 'Embedded development support'], 'from-[#e9e0ff] to-[#b79be9]'),
  quoteInventory('raspberry-pi-board', 'Raspberry Pi Board', 'Controllers & Boards', 'GEN-RPI-0001', 'Linux edge computing platform', 'A Raspberry Pi platform for dashboards, vision, automation gateways, and networked projects.', ['Raspberry Pi computer board', 'Linux-capable platform', 'USB and network connectivity'], 'from-[#ffe3d6] to-[#f1a17e]'),
  quoteInventory('l298n-motor-driver', 'L298N Motor Driver', 'Motors & Motion', 'GEN-MOT-0003', 'Dual-channel motor control', 'A dual H-bridge driver for DC motor direction and speed control in robot platforms.', ['Dual H-bridge driver', 'Direction and PWM inputs', 'Motor power terminal'], 'from-[#f1e9ff] to-[#c4a8ef]'),
  quoteInventory('l298p-motor-driver', 'L298P Motor Driver', 'Motors & Motion', 'GEN-MOT-0004', 'Compact motor-control board', 'A compact motor driver for embedded mobile robotics and classroom builds.', ['L298P driver board', 'Dual motor channels', 'Direction and speed control'], 'from-[#f1e9ff] to-[#c4a8ef]'),
  quoteInventory('stepper-motor', 'Stepper Motor', 'Motors & Motion', 'GEN-MOT-0005', 'Precise incremental motion', 'A stepper motor for positioning, mechanisms, and automation experiments.', ['Stepper motor', 'Incremental positioning', 'Driver required for operation'], 'from-[#fff1cf] to-[#f1c875]'),
  quoteInventory('bldc-motor', 'BLDC Motor', 'Motors & Motion', 'GEN-MOT-0006', 'Efficient high-speed motion', 'A brushless motor for drone, fan, and advanced motion projects.', ['Brushless DC motor', 'ESC required', 'High-speed motion platform'], 'from-[#ffe3d6] to-[#f1a17e]'),
  quoteInventory('bo-motor', 'BO Gear Motor', 'Motors & Motion', 'GEN-MOT-0007', 'Robot-car drive motor', 'A small BO geared motor matched to the Arduino robot-car builds in the source projects.', ['BO geared motor', 'Low-voltage operation', 'Robot-car mounting format'], 'from-[#f1e9ff] to-[#c4a8ef]'),
  quoteInventory('hc06-bluetooth', 'HC-06 Bluetooth Module', 'Communication Modules', 'GEN-COM-0001', 'Phone control for Arduino cars', 'A serial Bluetooth module used by the Arduino robot-car source projects for manual control.', ['HC-06 serial Bluetooth', 'UART interface', 'Phone pairing support'], 'from-[#dce8ff] to-[#7e9ff2]'),
  quoteInventory('oled-display-13', '1.3-inch OLED Display', 'Displays & Interfaces', 'GEN-DSP-0001', 'Live robot telemetry', 'A small OLED display for robot status, modes, speed, and sensor feedback.', ['1.3-inch OLED', 'SH1106 or SSD1306 compatible', 'I2C interface'], 'from-[#dff4ec] to-[#79c7a8]'),
  quoteInventory('oled-display-09', '0.9-inch OLED Display', 'Displays & Interfaces', 'GEN-DSP-0002', 'Compact status display', 'A compact OLED option for small embedded controllers and robot builds.', ['0.9-inch OLED', 'I2C interface', 'Compact embedded display'], 'from-[#dff4ec] to-[#79c7a8]'),
  quoteInventory('lipo-battery-pack', 'LiPo Battery Pack', 'Power & Charging', 'GEN-PWR-0003', 'Lightweight mobile power', 'A rechargeable LiPo pack for mobile robotics and drone-related projects.', ['LiPo battery pack', 'Lightweight energy storage', 'Use with compatible charger and BMS'], 'from-[#ffe3d6] to-[#f1a17e]'),
  quoteInventory('dc-dc-converter', 'DC-DC Converter', 'Power & Charging', 'GEN-PWR-0004', 'Stable project voltage', 'A voltage converter for powering controllers, sensors, displays, and motor systems safely.', ['DC-DC converter', 'Input/output voltage regulation', 'Project power integration'], 'from-[#fff1cf] to-[#f1c875]'),
  quoteInventory('battery-bms', 'Battery Management System', 'Power & Charging', 'GEN-PWR-0005', 'Protected rechargeable packs', 'A BMS module for monitoring and protecting compatible rechargeable battery packs.', ['Battery protection board', 'Charge and discharge protection', 'Pack integration support'], 'from-[#fff1cf] to-[#f1c875]'),
  quoteInventory('omni-wheel-set', 'Omni Wheel Set', 'Mechanical Parts', 'GEN-MEC-0003', 'Omnidirectional motion', 'Omni wheels for advanced mobile robot bases and maneuverability experiments.', ['Omni wheels', 'Multi-direction rollers', 'Robot chassis compatible'], 'from-[#e9e0ff] to-[#b79be9]'),
  quoteInventory('caster-wheel', 'Robot Caster Wheel', 'Mechanical Parts', 'GEN-MEC-0004', 'Stable third-point support', 'A caster for two-wheel robot platforms and balanced mobile chassis.', ['Caster wheel', 'Mounting plate', 'Mobile chassis support'], 'from-[#e9e0ff] to-[#b79be9]'),
  ...
  quoteInventory('xt60-power-connectors', 'XT60 Power Connectors', 'Connectors & Cables', 'GEN-CON-0003', 'Secure battery connection', 'High-current connectors for battery-powered robotics and drone projects.', ['XT60 connector pair', 'High-current power connection', 'Polarity-aware assembly'], 'from-[#ffe3d6] to-[#f1a17e]'),
  quoteInventory('multimeter', 'Digital Multimeter', 'Tools & Fabrication', 'GEN-TOL-0002', 'Measure before debugging', 'A practical multimeter for voltage, continuity, resistance, and safe electronics troubleshooting.', ['Digital multimeter', 'Voltage and continuity modes', 'Test leads'], 'from-[#fff1cf] to-[#f1c875]'),
  quoteInventory('abs-filament', 'ABS Maker Filament · 1 kg', '3D Printing Materials', 'GEN-3DP-0004', 'Durable printed parts', 'ABS filament for stronger functional prototypes and workshop parts where suitable ventilation is available.', ['1.75 mm diameter', '1 kg spool', 'Higher-temperature printing material'], 'from-[#dce8ff] to-[#7e9ff2]'),
]
