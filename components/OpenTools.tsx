...
const tools: Tool[] = [
  {
    group: "CAD & 3D",
    name: "OpenSCAD",
    description: "Parametric 3D design for printable parts.",
    href: "https://openscad.org/",
  },
  {
    group: "CAD & 3D",
    name: "FreeCAD",
    description: "Open-source mechanical CAD for precise models.",
    href: "https://www.freecad.org/",
  },
  {
    group: "Slicing",
    name: "PrusaSlicer",
    description: "Prepare STL and 3MF files for FDM printing.",
    href: "https://www.prusa3d.com/page/prusaslicer_424/",
  },
  {
    group: "Electronics",
    name: "KiCad",
    description: "Design schematics and PCBs without a subscription.",
    href: "https://www.kicad.org/",
  },
  {
    group: "Robotics",
    name: "Arduino IDE",
    description: "Write and upload firmware for classroom boards.",
    href: "https://www.arduino.cc/en/software/",
  },
  {
    group: "Robotics",
    name: "PlatformIO",
    description: "A professional embedded development workflow.",
    href: "https://platformio.org/",
  },
  {
    group: "Simulation",
    name: "Wokwi",
    description: "Simulate Arduino and ESP32 projects in the browser.",
    href: "https://wokwi.com/",
  },
  {
    group: "Images",
    name: "Wikimedia Commons",
    description: "Reusable media and diagrams with license details.",
  ...
  return (
    <section className="mx-auto max-w-7xl px-5 py-12 lg:px-8 lg:py-16">
      ...
      <p className="mt-4 max-w-2xl text-base leading-7 text-muted lg:text-lg">
        A small directory of open-source software for CAD, printing, electronics, and simulation.
      </p>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {visible.map((tool) => (
          <article
            key={tool.name}
            className="rounded-2xl border-t-2 border-navy bg-white p-5 shadow-card"
          >
