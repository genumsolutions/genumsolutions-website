    ...
    <section className="mt-12 border-t border-line pt-8 sm:mt-16 sm:pt-10">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <p className="max-w-md text-sm leading-6 text-muted">
          These libraries open in a new tab - they do not allow embedding, so we link straight to
          the source.
        </p>
      </div>
          ...
          >
            <span className="flex items-center justify-between gap-3">
              ...
              <ArrowUpRight
                size={18}
                aria-hidden="true"
                className="text-muted transition group-hover:text-navy"
              />
            </span>
            ...
            <span className="mt-3 block truncate text-xs font-bold uppercase tracking-widest text-navy">
