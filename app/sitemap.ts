...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const pages = ['', '/about', '/services', '/products', '/projects', '/iot-remote', '/home-automation', '/smart-farm', '/smart-city', '/drones', '/3d-printing', '/journal', '/tools', '/contact', '/checkout', '/privacy', '/terms']
