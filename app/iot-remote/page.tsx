...
// =====================================================================
// /iot-remote - the single "test & play" surface for GENUM device control.
//
...
// Projects page is descriptions-only.
// =====================================================================

import { useState } from 'react'
import PageShell from '../../components/PageShell'
import CategoryControlPanel from '../../components/CategoryControlPanel'
import { PROJECT_CATEGORIES } from '../../lib/project-catalog'

export default function IotRemotePage() {
