    ...
    <main className="min-h-screen bg-mist">
      <header className="border-b border-line bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 overflow-hidden px-5 py-3 lg:px-8 lg:py-4">
          <Link href="/" className="group flex min-w-0 shrink items-center gap-3" aria-label="GENUM SOLUTIONS home">
            ...
            <span aria-hidden="true" className="hidden h-10 w-px shrink-0 bg-line sm:block" />
            <span className="min-w-0 leading-none">
              <strong className="block truncate font-display text-lg font-bold tracking-tight text-ink sm:text-[22px]">GENUM</strong>
              <span className="mt-1 block truncate text-[9px] font-bold uppercase tracking-[0.32em] text-navy sm:text-[10px]">Solutions Pvt.&thinsp;Ltd.</span>
            </span>
          </Link>
