...
function Agreement({ company }: { company: Company }) {
  return (
    <p>
      By ordering from this website you agree to these terms with {company.name} ({company.address},
      PAN {company.pan}).
    </p>
  );
}
...
function OrdersAndPricing() {
  return (
    <ul className="list-disc space-y-1 pl-5">
      ...
      <li>
        An order is a request to buy; it becomes binding when we confirm it by email or dispatch the
        goods.
      </li>
      <li>
        Project packages and training marked &quot;quote&quot; are priced individually after
        scoping.
      </li>
    </ul>
  );
...
function Payments() {
  return (
    <ul className="list-disc space-y-1 pl-5">
      ...
      <li>
        Failed or cancelled online payments leave the order unpaid; nothing is reserved until
        payment succeeds.
      </li>
    </ul>
  );
...
function Delivery() {
  return (
    <ul className="list-disc space-y-1 pl-5">
      ...
      <li>
        Kathmandu Valley delivery is free above NPR 5,000; elsewhere courier charges apply and are
...
function WarrantyAndReturns() {
  return (
    <ul className="list-disc space-y-1 pl-5">
      ...
      <li>
        Returns require original packaging and proof of purchase; contact us first for an
        authorisation.
      </li>
...
function TrainingPrograms() {
  return (
    <p>
      Workshop dates may shift for reasons beyond our control; we will reschedule rather than cancel
      where possible. School pilot agreements are governed by the signed proposal document.
    </p>
  );
}
...
function AcceptableUse() {
  return (
    <p>
      Do not attempt to breach site security, scrape at scale, resell curricula without licence, or
...
function Liability() {
  return (
    <p>
      To the extent permitted by law, our liability for any claim is limited to the amount you paid
...
function ChangesAndLaw() {
  return (
    <p>
      We may update these terms; the version in force is the one published when you order. These
      terms are governed by the laws of Nepal, courts of Kathmandu.
    </p>
  );
}
